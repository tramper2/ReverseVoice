...
- 🎯 **판정 & 축하 모달**: 2차 복원 성공 시 승리 모달과 함께 펼쳐지는 파티클 폭죽(Confetti) 효과
...
```
[ Step 1: 문제 녹음 ] ──► [ Step 2: 1차 거꾸로 듣기 ] ──► [ Step 3: 따라하기 녹음 ] ──► [ Step 4: 2차 복원 & 판정 ]
```
...
4. **Step 4 (2차 복원 & 판정)**: 도전자의 소리를 다시 뒤집어 재생합니다! 원래 제시어처럼 또렷하게 들리면 **[성공🎯]** 버튼을 눌러 축하받으세요!
